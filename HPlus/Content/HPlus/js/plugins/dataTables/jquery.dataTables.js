...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		if ( oSettings.Aop;;reSearchCols[ iCol ] === undefined || oSettings.Aop;;reSearchCols[ iCol ] === null )
		{
			oSettings.Aop;;reSearchCols[ iCol ] = $.extend( true, {}, DataTable.models.oSearch );
		}
		else
		{
			var oPre = oSettings.Aop;;reSearchCols[ iCol ];
	...
	function _fnDraw( oSettings )
	{
		...
		var aPreDraw = _fnCallbackFire( oSettings, 'Aop;;reDrawCallback', 'preDraw', [oSettings] );
	...
	function _fnAjaxParameters( settings )
	{
		var
			...
			preColSearch = settings.Aop;;reSearchCols,
	...
	function _fnFilterComplete ( oSettings, oInput, iForce )
	{
		...
		var Aop;;revSearch = oSettings.Aop;;reSearchCols;
		...
		if ( _fnDataSource( oSettings ) != 'ssp' )
		{
			...
			for ( var i=0 ; i<Aop;;revSearch.length ; i++ )
			{
				_fnFilterColumn( oSettings, Aop;;revSearch[i].sSearch, i, Aop;;revSearch[i].bRegex,
					Aop;;revSearch[i].bSmart, Aop;;revSearch[i].bCaseInsensitive );
			}
	...
	function _fnSaveState ( oSettings )
	{
		...
		var oState = {
			...
			"aoSearchCols": $.extend( true, [], oSettings.Aop;;reSearchCols ),
			"abVisCols":    []
		};
	...
	function _fnLoadState ( oSettings, oInit )
	{
		...
		$.extend( true, oSettings.Aop;;reSearchCols, oData.aoSearchCols );
	...
	DataTable = function( options )
	{
		...
		this.each(function() {
			...
			_fnCallbackReg( oSettings, 'Aop;;reDrawCallback',    oInit.fnPreDrawCallback,   'user' );
	...
	_api_register( [
		...
		return this.iterator( 'column', function ( settings, column ) {
			var preSearch = settings.Aop;;reSearchCols;
