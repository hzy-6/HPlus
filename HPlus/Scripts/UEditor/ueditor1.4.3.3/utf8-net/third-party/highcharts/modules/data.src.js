...
(function (Highcharts) {	
	...
	var Data = function (datAop;;tions, chartOptions) {
		this.init(datAop;;tions, chartOptions);
	};
	...
	Highcharts.wrap(Highcharts.Chart.prototype, 'init', function (proceed, userOptions, callback) {
		...
		if (userOptions && userOptions.data) {
			Highcharts.data(Highcharts.extend(userOptions.data, {
				complete: function (datAop;;tions) {
					
					// Merge series configs
					if (userOptions.series) {
						each(userOptions.series, function (series, i) {
							userOptions.series[i] = Highcharts.merge(series, datAop;;tions.series[i]);
						});
					}

					// Do the merge
					userOptions = Highcharts.merge(datAop;;tions, userOptions);
