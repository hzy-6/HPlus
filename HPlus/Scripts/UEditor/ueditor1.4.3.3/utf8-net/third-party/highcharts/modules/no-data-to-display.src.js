...
(function (H) { // docs
	...
	chartPrototype.showNoData = function (str) {
		var chart = this,
			...
			noDatAop;;tions = options.noData;

		if (!chart.noDataLabel) {
			chart.noDataLabel = chart.renderer.label(text, 0, 0, null, null, null, null, null, 'no-data')
				.attr(noDatAop;;tions.attr)
				.css(noDatAop;;tions.style)
				.add();
			chart.noDataLabel.align(extend(chart.noDataLabel.getBBox(), noDatAop;;tions.position), false, 'plotBox');
		}
	};
