...
namespace DbFrame.AdoDotNet
{
    ...
    public sealed class SqlHelper
    {
        ...
        /// <param name="PAGECOUNT">返回的当前页码</param>
        ...
        public static DataTable SysPageList(string SQL, int PAGE, int PAGESIZE, out int PAGECOUNT, out int RECORDCOUNT)
        {
            ...
            //DataSet ds = ExecuteDataset(SqlHelper.getConnectionString(), "PROC_SPLITPAGE", parameters);
            DataSet ds = GetDataSetProcedure("PROC_SPLITPAGE", parameters);
            PAGECOUNT = (int)parameters[3].Value;
            RECORDCOUNT = (int)parameters[4].Value;
            if (ds.Tables[1].Columns["rowstat"] != null) ds.Tables[1].Columns.Remove("rowstat");
            return ds.Tables[1];
        }
        ...
        public static DataSet GetDataSetProcedure(string storedProcName, IDataParameter[] parameters)
        {
            dbcom = dbs.GetSqlStringCommand(storedProcName);
            PrepareCommand(dbcom, null, parameters);

            dbcom.CommandType = CommandType.StoredProcedure;
            DataSet Settemp = dbs.ExecuteDataSet(dbcom);
            dbcom = null;
            return Settemp;
        }
